    ...
    <section className={`py-16 lg:py-24 ${className}`}>
      <div className="container mx-auto px-4">
        ...
        <div className={`grid gap-12 ${isMobile ? 'grid-cols-1' : 'grid-cols-1 lg:grid-cols-3'}`}>
          ...
          <div className={`relative bg-secondary/10 pt-14 pb-8 px-6 lg:px-8 rounded-[2.5rem] border border-border shadow-sm h-full flex flex-col ${isMobile ? 'order-1 mb-12' : 'order-2'}`}>
