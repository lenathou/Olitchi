...
// ──────────────────────────────────────────────
// Variants pour la page /a-propos
// ──────────────────────────────────────────────
...
/** Stagger pour les headers (icon/badge → titre → paragraphe) */
...
/** Reveal pour chaque card (avec scale) */
...
/** Scale reveal pour les éléments centrés (CTA, citations) */
